...
#+BEGIN_SRC emacs-lisp :tangle (when (getenv "USE_EXWM") "yes")
...
TODO: git gutter not showing up before making changes... I need to save before it shows... sometimes never...
